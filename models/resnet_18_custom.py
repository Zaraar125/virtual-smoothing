...
class ResNet(nn.Module):
    def __init__(self, block, num_blocks,base_width, num_real_classes=10, num_v_classes=0, normalizer=None, output_real_only=False,
        ...
        self.linear = nn.Linear(base_width*8 * block.expansion,num_real_classes + num_v_classes)
...
def ResNet18(num_blocks=[2,2,2,2], base_width=64,num_real_classes=10, num_v_classes=0, normalizer=None, output_real_only=False, output_v_only=False,
             add_real_v=False):
    return ResNet(BasicBlock, num_blocks,base_width, num_real_classes=num_real_classes, num_v_classes=num_v_classes,
